...
//    vpHypo.resize(it*numVp2, std::vector<cv::Point3d>(it*numVps, 3));
    vpHypo.resize(it*numVp2);
    for(int i =0; i < it*numVp2; i++)
        vpHypo[i].resize(3);
