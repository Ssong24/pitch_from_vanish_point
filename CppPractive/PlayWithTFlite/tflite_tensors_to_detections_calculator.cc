...
//
//
//// to make calculators know to it.
...
//}
//
//absl::Status TfLiteTensorsToDetectionsCalculator::DecodeBoxes(const TfLiteTensorsToDetectionsCalculatorOptions &options_, const float* raw_boxes, const std::vector<Anchor>& anchors, std::vector<float>* boxes)
//{
//    
//  for (int i = 0; i < num_boxes_; ++i) {
