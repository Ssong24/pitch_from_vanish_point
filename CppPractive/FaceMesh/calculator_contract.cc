...
#include "calculator_contract.h" //"mediapipe/framework/calculator_contract.h"
...
#include "status.h" // "mediapipe/framework/port/status.h"
#include "status_builder.h"  //"mediapipe/framework/port/status_builder.h"
#include "status_macros.h"  //"mediapipe/framework/port/status_macros.h"
#include  "packet_generator_wrapper_calculator" //"mediapipe/framework/tool/packet_generator_wrapper_calculator.pb.h"
#include "tag_map.h" //"mediapipe/framework/tool/tag_map.h"
