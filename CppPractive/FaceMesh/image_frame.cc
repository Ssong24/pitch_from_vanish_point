...
#include "image_format.pb.h"
#include "aligned_malloc_and_free.h"
#include "logging.h"
#include "proto_ns.h"
...
//      warn_message = "Format with number ? is not a valid format."
//      return warn_mesage;
////    return "Format is not valide" absl::StrCat("Format with number ", format,                         " is not a valid format.");
//  } else {
//      warn_meesage = "Format ", enum_value_descriptor->DebugString(),
